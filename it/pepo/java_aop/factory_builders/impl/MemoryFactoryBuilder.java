package it.pepo.java_aop.factory_builders.impl;

import it.pepo.java_aop.factories.IFactory;
import it.pepo.java_aop.factories.models.memory_compz.CharSequenceJavaFileObject;
import it.pepo.java_aop.factories.models.memory_compz.ClassFileManager;
import it.pepo.java_aop.factory_builders.FactoryBuilder;
import it.pepo.java_aop.utils.Utilities;
...
public class MemoryFactoryBuilder implements FactoryBuilder{
	...
	private static final String MEM_FACTORY_PACKAGE_NAME = "it.pepo.java_aop.factories.impl.build";
	private static final String IFACTORY_PACKAGE_NAME = "it.pepo.java_aop.factories";
	private static final String FMODEL_PACKAGE_NAME = "it.pepo.java_aop.factories.models.json";
	...
	public int buildFactory(StringBuffer sBuffer) throws FileNotFoundException {
        ...
        jfiles.add(new CharSequenceJavaFileObject(FULL_NAME, sBuffer));   
	...
	public IFactory loadFactory(String runtimeClassesFolder,
		...
		Class cls1  = fileManager.getClassLoader(null)
	    		 .loadClass(FULL_NAME);
